...
package xds.courses.android_2.lesson_02.app02.data;
...
import xds.courses.android_2.lesson_02.app02.R;
...
public class DBEmpl extends DBSQLite {
     ...
     * @return The row ID of the newly inserted department, or -1 if an error occurred.
     * */
    public long addDep(ContentValues values) {
        return this.getWritableDatabase().insert(DBEmplInfo.TableDep.T_NAME, null, values);
    }
